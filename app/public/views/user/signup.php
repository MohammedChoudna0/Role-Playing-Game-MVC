        ...
        <main>
            <div class="row row-cols-1 row-cols-md-3 mb-3 ">
                <div class="col-md-12 d-flex justify-content-center">
                    <form class="form-horizontal" role="form" method="POST" action="../../../controllers/user/insertController.php" style ="width:350px">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="nombre apellidos" name="name">
                        </div>
